...
public class Liferay62Adapter implements LiferayAdapter {
    ...
    @Override
    public String createOrUpdateUser(long companyId, String emailAddress, String firstName, String lastName, String oidcData) {
        ...
        try {
            ...
            if (user == null) {
                ...
                user = addUser(companyId, emailAddress, firstName, lastName, oidcData);
            } else {
                LOG.debug("User found, updating name details with info from userinfo");
                updateUser(user, firstName, lastName, oidcData);
            }
    ...
    protected User addUser(
            long companyId, String emailAddress, String firstName, String lastName, String oidcData)
    ...
    private void updateUser(User user, String firstName, String lastName, String oidcData) {
        user.setFirstName(firstName);
        user.setLastName(lastName);
        user.setOpenId(oidcData);
        try {
            UserLocalServiceUtil.updateUser(user);
